...
mod tests {
    ...
    #[test]
    fn test_get_stone() {
        let mut inventory = PlayerInventory { player: starknet::contract_address_const::<'PLAYER'>(), data: 8192, coins: 0, rebirth_credits: 0 };
    ...
    #[test]
    fn test_get_diamond() {
        let mut inventory = PlayerInventory { player: starknet::contract_address_const::<'PLAYER'>(), data: 9439544818968559616, coins: 0, rebirth_credits: 0 };
    ...
    fn test_get_and_sell_all() {
        let mut inventory = PlayerInventory { player: starknet::contract_address_const::<'PLAYER'>(), data: 0, coins: 0, rebirth_credits: 0 };
